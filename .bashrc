...
alias add-shell='busybox add-shell'
...
alias ascii='busybox ascii'
alias ash='busybox ash'
alias awk='busybox awk'
alias base32='busybox base32'
...
alias bootchartd='busybox bootchartd'
...
alias df='busybox df'
alias dhcprelay='busybox dhcprelay'
...
alias dpkg='busybox dpkg'
alias dpkg-deb='busybox dpkg-deb'
alias du='busybox du'
alias dumpkmap='busybox dumpkmap'
alias dumpleases='busybox dumpleases'
alias echo='busybox echo'
alias ed='busybox ed'
alias egrep='busybox egrep'
alias eject='busybox eject'
alias env='busybox env'
alias envdir='busybox envdir'
alias envuidgid='busybox envuidgid'
alias ether-wake='busybox ether-wake'
alias expand='busybox expand'
alias expr='busybox expr'
alias factor='busybox factor'
alias fakeidentd='busybox fakeidentd'
...
alias fdformat='busybox fdformat'
alias fdisk='busybox fdisk'
alias fgconsole='busybox fgconsole'
...
alias fsck.minix='busybox fsck.minix'
alias fsfreeze='busybox fsfreeze'
...
alias hd='busybox hd'
alias hdparm='busybox hdparm'
alias head='busybox head'
alias hexdump='busybox hexdump'
alias hexedit='busybox hexedit'
alias hostid='busybox hostid'
alias hostname='busybox hostname'
alias httpd='busybox httpd'
alias hush='busybox hush'
alias hwclock='busybox hwclock'
alias i2cdetect='busybox i2cdetect'
alias i2cdump='busybox i2cdump'
alias i2cget='busybox i2cget'
alias i2cset='busybox i2cset'
alias i2ctransfer='busybox i2ctransfer'
alias id='busybox id'
alias ifconfig='busybox ifconfig'
alias ifdown='busybox ifdown'
alias ifenslave='busybox ifenslave'
alias ifplugd='busybox ifplugd'
...
alias kbd_mode='busybox kbd_mode'
alias kill='busybox kill'
alias killall='busybox killall'
alias killall5='busybox killall5'
...
alias nbd-client='busybox nbd-client'
alias nc='busybox nc'
...
alias popmaildir='busybox popmaildir'
alias poweroff='busybox poweroff'
alias powertop='busybox powertop'
...
alias readprofile='busybox readprofile'
...
alias rpm2cpio='busybox rpm2cpio'
alias rtcwake='busybox rtcwake'
alias run-init='busybox run-init'
alias run-parts='busybox run-parts'
alias runsv='busybox runsv'
alias runsvdir='busybox runsvdir'
alias rx='busybox rx'
alias script='busybox script'
alias scriptreplay='busybox scriptreplay'
alias sed='busybox sed'
alias seedrng='busybox seedrng'
alias sendmail='busybox sendmail'
alias seq='busybox seq'
alias setarch='busybox setarch'
alias setconsole='busybox setconsole'
alias setfattr='busybox setfattr'
...
alias setuidgid='busybox setuidgid'
alias sh='busybox sh'
...
alias smemcap='busybox smemcap'
alias softlimit='busybox softlimit'
alias sort='busybox sort'
alias split='busybox split'
alias ssl_client='busybox ssl_client'
...
alias su='busybox su'
alias sulogin='busybox sulogin'
alias sum='busybox sum'
alias sv='busybox sv'
alias svc='busybox svc'
alias svlogd='busybox svlogd'
alias svok='busybox svok'
...
alias taskset='busybox taskset'
alias tcpsvd='busybox tcpsvd'
...
alias tree='busybox tree'
alias true='busybox true'
alias truncate='busybox truncate'
alias ts='busybox ts'
alias tsort='busybox tsort'
alias tty='busybox tty'
alias ttysize='busybox ttysize'
alias tunctl='busybox tunctl'
alias ubiattach='busybox ubiattach'
alias ubidetach='busybox ubidetach'
alias ubimkvol='busybox ubimkvol'
alias ubirename='busybox ubirename'
alias ubirmvol='busybox ubirmvol'
alias ubirsvol='busybox ubirsvol'
alias ubiupdatevol='busybox ubiupdatevol'
alias udhcpc='busybox udhcpc'
alias udhcpc6='busybox udhcpc6'
alias udhcpd='busybox udhcpd'
alias udpsvd='busybox udpsvd'
alias uevent='busybox uevent'
